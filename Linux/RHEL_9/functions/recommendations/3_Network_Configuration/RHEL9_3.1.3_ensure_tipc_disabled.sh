...
#                                                                            #
# File Name:   RHEL9_3.1.3_ensure_tipc_disabled.sh                           #
# Description: Ensures TIPC is disabled                                      #
#                                                                            #
##############################################################################
...
ensure_tipc_disabled()
{
	...
	ensure_tipc_disabled_chk()
	{
		...
		echo "- Start check - Ensure TIPC is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
		...
		if [ -z "$l_output2" ]; then 
			...
			echo "- End check - Ensure TIPC is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
		echo "- Start remediation - Ensure TIPC is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
		...
		echo "- End remediation - Ensure TIPC is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

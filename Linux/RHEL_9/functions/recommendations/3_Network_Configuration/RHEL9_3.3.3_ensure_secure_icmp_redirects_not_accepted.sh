...
#                                                                            #
# File Name:   RHEL9_3.3.3_ensure_secure_icmp_redirects_not_accepted.sh      #
# Description: Ensures secure ICMP redirects are not accepted                #
#                                                                            #
##############################################################################
...
ensure_secure_icmp_redirects_not_accepted()
{
	...
	{
        echo "- Start check - Ensure secure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
        l_output="" l_output2="" 
        ...
        if [ -z "$l_output2" ]; then 
            ...
            echo "- End check - Ensure secure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
        echo "- Start remediation - Ensure secure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
        l_output="" l_output2="" 
        ...
        echo "- End remediation - Ensure secure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

...
#                                                                            #
# File Name:   RHEL9_3.3.2_ensure_icmp_redirects_not_accepted.sh             #
# Description: Ensures ICMP redirects are not accepted                       #
#                                                                            #
##############################################################################
...
ensure_icmp_redirects_not_accepted()
{
	...
	{
		echo "- Start check - Ensure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
		l_output="" l_output2="" 
		...
		if [ -z "$l_output2" ]; then 
			...
			echo "- End check - Ensure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
		echo "- Start remediation - Ensure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
		l_output="" l_output2="" 
		...
		echo "- End remediation - Ensure ICMP redirects are not accepted" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

...
#                                                                            #
# File Name:   RHEL9_3.2.1_ensure_ip_forwarding_disabled.sh                  #
# Description: Ensures IP forwarding is disabled                             #
#                                                                            #
##############################################################################
...
ensure_ip_forwarding_disabled()
{
	...
	{
		echo "- Start check - Ensure IP forwarding is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
		l_output="" l_output2="" 
	...
	{
		echo "- Start remediation - Ensure IP forwarding is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
		l_output="" l_output2="" 
		...
		echo "- End remediation - Ensure IP forwarding is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

...
#                                                                            #
# File Name:   RHEL9_3.3.8_ensure_tcp_syn_cookies_enabled.sh                 #
# Description: Ensures TCP SYN Cookies is enabled                            #
#                                                                            #
##############################################################################
...
ensure_tcp_syn_cookies_enabled()
{
	...
	{
        echo "- Start check - Ensure TCP SYN Cookies is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
        l_output="" l_output2="" 
        ...
        if [ -z "$l_output2" ]; then 
            ...
            echo "- End check - Ensure TCP SYN Cookies is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
        echo "- Start remediation - Ensure TCP SYN Cookies is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
        l_output="" l_output2="" 
        ...
        echo "- End remediation - Ensure TCP SYN Cookies is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

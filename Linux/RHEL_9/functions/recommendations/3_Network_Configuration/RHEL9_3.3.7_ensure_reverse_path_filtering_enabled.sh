...
#                                                                            #
# File Name:   RHEL9_3.3.7_ensure_reverse_path_filtering_enabled.sh          #
# Description: Ensures Reverse Path Filtering is enabled                     #
#                                                                            #
##############################################################################
...
ensure_reverse_path_filtering_enabled()
{
	...
	{
        echo "- Start check - Ensure Reverse Path Filtering is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
        l_output="" l_output2="" 
        ...
        if [ -z "$l_output2" ]; then 
            ...
            echo "- End check - Ensure Reverse Path Filtering is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
        echo "- Start remediation - Ensure Reverse Path Filtering is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
        l_output="" l_output2="" 
        ...
        echo "- End remediation - Ensure Reverse Path Filtering is enabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

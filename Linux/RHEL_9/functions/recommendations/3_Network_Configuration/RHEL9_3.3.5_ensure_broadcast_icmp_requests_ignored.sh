...
#                                                                            #
# File Name:   RHEL9_3.3.5_ensure_broadcast_icmp_requests_ignored.sh         #
# Description: Ensures broadcast ICMP requests are ignored                   #
#                                                                            #
##############################################################################
...
ensure_broadcast_icmp_requests_ignored()
{
	...
	{
        echo "- Start check - Ensure broadcast ICMP requests are ignored" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
        l_output="" l_output2="" 
        ...
        if [ -z "$l_output2" ]; then 
            ...
            echo "- End check - Ensure broadcast ICMP requests are ignored" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
        echo "- Start remediation - Ensure broadcast ICMP requests are ignored" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
        l_output="" l_output2="" 
        ...
        echo "- End remediation - Ensure broadcast ICMP requests are ignored" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

...
#                                                                            #
# File Name:   RHEL9_3.2.2_ensure_packet_redirect_sending_disabled.sh        #
# Description: Ensures packet redirect sending is disabled                   #
#                                                                            #
##############################################################################
...
ensure_packet_redirect_sending_disabled()
{
	...
	{
        echo "- Start check - Ensure packet redirect sending is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
        l_output="" l_output2="" 
        ...
        if [ -z "$l_output2" ]; then 
            ...
            echo "- End check - Ensure packet redirect sending is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
        echo "- Start remediation - Ensure packet redirect sending is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
        l_output="" l_output2="" 
        ...
        echo "- End remediation - Ensure packet redirect sending is disabled" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}

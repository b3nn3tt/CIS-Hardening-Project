...
#                                                                            #
# File Name:   RHEL9_3.3.4_ensure_suspicious_packets_logged.sh               #
# Description: Ensures suspicious packets are logged                         #
#                                                                            #
##############################################################################
...
ensure_suspicious_packets_logged()
{
	...
	{
        echo "- Start check - Ensure suspicious packets are logged" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG" 
        l_output="" l_output2="" 
        ...
        if [ -z "$l_output2" ]; then 
            ...
            echo "- End check - Ensure suspicious packets are logged" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	...
	{
        echo "- Start remediation - Ensure suspicious packets are logged" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
        l_output="" l_output2="" 
        ...
        echo "- End remediation - Ensure suspicious packets are logged" | tee -a "$VERBOSE_LOG" 2>> "$ERROR_LOG"
	}
